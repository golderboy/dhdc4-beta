    ...
    public function behaviors() {        
        ...
        return [
            'access' => [
                ...
                'only' => ['index', 'view', 'create', 'update', 'delete', 'detail', 'detail2', 'importall'],
                'rules' => [
                    [
                        'actions' => ['index', 'view', 'update', 'delete', 'detail', 'detail2', 'importall'],
                        'allow' => true,
                        'roles' => ['Admin'],
                    ],
                    [
                        'actions' => ['index', 'view', 'detail', 'detail2'],
                        'allow' => true,
                        'roles' => ['User'],
                    ],
                    [
