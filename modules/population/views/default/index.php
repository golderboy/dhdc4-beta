...
<div class="dhdc-page-header">
    <div>
        <h1 class="dhdc-page-title">Population</h1>
        <div class="dhdc-page-subtitle">วิเคราะห์โครงสร้างประชากรจากข้อมูลจริงของระบบเดิม</div>
    </div>
    <div class="dhdc-toolbar">
        <?= Html::a('TYPEAREA', ['typearea'], ['class' => 'btn btn-info']) ?>
        <?= Html::a('แผนที่ความหนาแน่น', ['map'], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
    </div>
</div>
...
<div class="dhdc-panel">
    <div class="dhdc-section-title">ตัวกรองหน่วยบริการ</div>
    <?php
    ActiveForm::begin([
        'method' => 'get',
        'action' => Url::to(['index'])
    ...
    <div class="row dhdc-filter-row">
        ...
        <div class="col-sm-8">
            <div class="dhdc-toolbar">
                ...
                <?= Html::a('TYPEAREA', ['typearea'], ['class' => 'btn btn-info']) ?>
                <?= Html::a('ความหนาแน่น', ['map'], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
            </div>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
...
<div class="dhdc-panel dhdc-chart-shell">
    <div class="dhdc-section-title">Population pyramid</div>
    <div id="pyramid"></div>
</div>
...
$hospcodeTitle = $hospcode ? $hospcode : 'ทุกหน่วยบริการ';
...
$('#pyramid').highcharts({
    ...
    title: {
        text: 'ปิรามิดประชากร $hospcodeTitle'
    },
    subtitle: {
...
<div class="pop-grid dhdc-panel dhdc-grid-shell">
<?php
